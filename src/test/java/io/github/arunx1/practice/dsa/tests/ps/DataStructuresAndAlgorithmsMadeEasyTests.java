...
import io.github.arunx1.practice.dsa.dataStructures.LinkedList;
import io.github.arunx1.practice.dsa.dataStructures.helpers.ListNode;
import io.github.arunx1.practice.dsa.ps.dataStructuresAndAlgorithmsMadeEasy.*;
import io.github.arunx1.practice.dsa.tests.ps.dataProviders.DataStructuresAndAlgorithmsMadeEasyDataProviders;
...
public class DataStructuresAndAlgorithmsMadeEasyTests {
    ...
    @Test(description = "02.01 Print moves for moving disks from Tower 'A' to tower 'B' using Towers of Hanoi puzzle",
            ...
            dataProviderClass = DataStructuresAndAlgorithmsMadeEasyDataProviders.class,
            threadPoolSize = 10,
